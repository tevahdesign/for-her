          ...
          <ScrollReveal delay={0}>
            ...
            >
              <div className="px-8 py-6">
                <h3 className="font-serif text-3xl text-black mb-1">Wedding</h3>
                <p className="text-sm tracking-[0.2em] uppercase text-[#C4A57B] font-sans mb-2">
                  Muhurtham · 10:30 AM
                </p>
                <p className="text-sm tracking-wider text-black/60 font-sans mb-1">Sunday, Oct 25th</p>
                <p className="text-sm tracking-wider text-black/50 font-sans flex items-center gap-1">
                  <MapPin className="w-3.5 h-3.5 text-[#C4A57B] flex-shrink-0" />
                  Reef Club Resort, Eranhikkal, Calicut
                </p>
              </div>
            </motion.div>
          </ScrollReveal>
            ...
            >
              ...
              >
                <div className="flex-1">
                  ...
                  <p className="text-sm tracking-wider text-black/60 font-sans">Saturday, Oct 24th · 5PM – 8PM</p>
                </div>
                <motion.div
                  animate={{ rotate: openEvent === 'reception' ? 180 : 0 }}
                      ...
                      <div className="space-y-6">
                        ...
                        >
                          ...
                          <div>
                            ...
                            <p className="font-serif text-lg text-black">Century Auditorium, Mele Chelari</p>
                          </div>
                        </motion.div>
                        <motion.div
